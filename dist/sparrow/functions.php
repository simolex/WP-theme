...
function sparrow_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'sparrow_custom_background_args',
			array(
...
function sparrow_scripts() {
	wp_enqueue_style( 'sparrow-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'sparrow-style', 'rtl', 'replace' );

	wp_enqueue_script( 'sparrow-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
